...
## Project Structure
    ...
    ├── testapiautosetting_127223  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127223`
...
2. Clone this repo and `cd testapiautosetting_127223`
